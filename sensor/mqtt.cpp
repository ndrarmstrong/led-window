...
void Mqtt::subscribe()
{
    ...
    mqttClient.subscribe(deviceReqTopic(Config::MQTT_MSG_TOPIC_INTERVAL).c_str());
    mqttClient.subscribe(deviceReqTopic(Config::MQTT_MSG_TOPIC_LIGHT_LEVEL).c_str());
    mqttClient.subscribe(deviceReqTopic(Config::MQTT_MSG_TOPIC_LUX).c_str());
    mqttClient.subscribe(deviceReqTopic(Config::MQTT_MSG_TOPIC_RGB).c_str());
